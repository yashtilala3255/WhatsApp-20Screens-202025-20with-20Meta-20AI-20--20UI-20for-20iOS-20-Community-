...
const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  const CheckMark = () => (
    <div className="w-[17px] h-[17px] relative">
      <svg
        className="w-[14px] h-[9px] absolute left-[1px] top-[4px] fill-[#007BFC]"
        viewBox="0 0 15 11"
      >
  ...
  const Tail = ({ type }: { type: "friend" | "me" }) => {
    if (type === "friend") {
      return (
        <svg
          className="w-[15px] h-[18px] absolute -left-[7.5px] bottom-0"
          viewBox="0 0 16 20"
        >
          <path
            d="M8 4.83984L8 0.839844H15.5V14.8398C11.8406 18.0926 4.87479 18.7003 2.40001 18.8138C2.09291 18.8279 1.93536 18.4419 2.15211 18.2239C3.7998 16.5668 8 11.6726 8 4.83984Z"
            fill="white"
          />
        </svg>
      );
      ...
      return (
        <svg
          className="w-[15px] h-[18px] absolute -right-[7.5px] bottom-0"
          viewBox="0 0 16 19"
        >
          <path
            d="M8 4.33984L8 0.339844H0.5V14.3398C4.15938 17.5926 11.1252 18.2003 13.6 18.3138C13.9071 18.3279 14.0646 17.9419 13.8479 17.7239C12.2002 16.0668 8 11.1726 8 4.33984Z"
            fill="#D0FECF"
          />
        </svg>
      );
  ...
  const VoiceWaveform = () => {
    const bars = [
      8, 14, 16, 15, 24, 20, 15, 18, 12, 15, 18, 10, 8, 6, 24, 20, 12, 18, 14,
      10, 4, 15, 18, 10, 14, 8, 12, 15, 18, 20, 12, 16, 10, 6, 8, 12, 18, 10,
    ];
  ...
  return (
    <div
      className={`flex ${isMe ? "justify-end" : "justify-start"} px-4 ${isMe ? "" : "pl-2"}`}
    >
      <div className="flex flex-col items-start gap-[-4px] max-w-[287px]">
        ...
        >
          ...
          <div
            className={`relative flex flex-col min-w-[88px] max-w-[287px] p-[10px] rounded-xl border border-black/[0.06] ${bubbleColor}`}
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2 flex-1 pt-[5.5px]">
                  ...
                  <div className="flex justify-between items-center pl-9">
                    <span className="text-black/50 text-[11px] tracking-[0.55px]">
                      {voiceDuration || "0:25"}
                    </span>
            ...
            {messageType === "location" && (
              <div className="flex flex-col w-[279px]">
                <img
                  src={
                    locationImage ||
                    "https://cdn.builder.io/api/v1/image/assets%2F58a45ac74f684c229db5d48c4fd195ba%2Fafb5fb3d8aab422e9236c17c8380e530?format=webp&width=800"
                  }
                  alt="Map location"
                ...
                <div className="absolute bottom-0 right-0 w-[176px] h-[37px] bg-gradient-to-t from-black/53 to-transparent rounded-br-lg">
                  <div className="absolute right-[5px] top-[20px] flex items-center gap-[2px]">
                    <span className="text-white text-[11px] tracking-[0.55px]">
                      {time}
                    </span>
                  </div>
                </div>
...
const DateSeparator: React.FC<{ date: string }> = ({ date }) => (
  <div className="flex justify-center items-center py-6 px-0">
    <div className="flex min-w-[100px] px-[14px] py-[3px] justify-center items-center bg-white border border-black/[0.06] rounded-lg">
      <span className="text-[#0A0A0A] text-[12px] font-semibold text-center">
        {date}
      </span>
    </div>
  </div>
    ...
    <div className="flex flex-col w-full max-w-[393px] h-screen bg-[#F5F2EB] mx-auto relative overflow-hidden">
        ...
        <div className="flex justify-between items-center w-full relative">
          <div className="flex w-[272px] items-center gap-[-1px]">
            ...
            <div className="flex w-[31px] pr-1 items-center flex-shrink-0 self-stretch">
              <span className="flex-1 text-[#0A0A0A] text-[17px] font-medium tracking-[-0.336px] line-clamp-1">
                1
              </span>
            </div>
      ...
      <div className="flex-1 flex flex-col justify-end pb-2 gap-3 relative overflow-y-auto">
        ...
        <div className="flex flex-col gap-3 relative">
          ...
          <MessageBubble type="friend" message="Marty?" time="08:21" />
