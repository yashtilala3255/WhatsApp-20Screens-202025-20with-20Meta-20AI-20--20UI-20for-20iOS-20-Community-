...
export default function Profile() {
  ...
  const [profileImage, setProfileImage] = useState('https://api.builder.io/api/v1/image/assets/TEMP/7a8c2c85?width=116');
  ...
  const ProfileField: React.FC<{
    ...
    multiline?: boolean;
    readonly?: boolean;
  }> = ({ label, value, onValueChange, multiline = false, readonly = false }) => (
          ...
          <div className="mt-8">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="text-[17px] font-medium text-black">Privacy</h3>
                  <p className="text-[14px] text-[#667781]">Who can see my info</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="text-[17px] font-medium text-black">Security</h3>
                  <p className="text-[14px] text-[#667781]">Two-step verification</p>
                </div>
              </div>
              <svg width="8" height="14" viewBox="0 0 8 14" fill="none">
                <path
          ...
          <div className="mt-8 mb-8">
            ...
            <button className="w-full flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="text-[17px] font-medium text-black">Sign Out</h3>
                  <p className="text-[14px] text-[#667781]">Sign out of this account</p>
                </div>
              </div>
            </button>
            ...
            <button className="w-full flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h3 className="text-[17px] font-medium text-[#F44336]">Delete Account</h3>
                  <p className="text-[14px] text-[#667781]">Permanently delete this account</p>
                </div>
              </div>
            </button>
          </div>
