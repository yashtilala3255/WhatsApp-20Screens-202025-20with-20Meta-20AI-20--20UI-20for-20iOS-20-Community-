...
const mockMediaItems: MediaItem[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://api.builder.io/api/v1/image/assets/TEMP/video-thumb?width=400',
    date: 'Today',
    sender: 'Marty McFly',
  },
  {
  ...
  },
  {
    ...
    thumbnail: 'https://api.builder.io/api/v1/image/assets/TEMP/skateboard-thumb?width=400',
    date: 'Monday',
    sender: 'Marty McFly',
  },
];
...
export default function MediaGallery() {
  ...
  const mediaItems = mockMediaItems.filter(item => item.type === 'photo' || item.type === 'video');
    ...
    <div className="relative aspect-square">
      ...
      >
        <img
          ...
          onError={(e) => {
            e.currentTarget.src = 'https://api.builder.io/api/v1/image/assets/placeholder-media';
          }}
        />
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-[20px] font-semibold text-black">
            {isSelectionMode ? `${selectedItems.length} selected` : 'Media Gallery'}
          </h1>
        </div>
        ...
        {isSelectionMode ? (
          <div className="flex items-center gap-2">
            <button className="p-2 rounded-full hover:bg-gray-100 transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 16.5V18.75C3 19.9926 4.00736 21 5.25 21H18.75C19.9926 21 21 19.9926 21 18.75V16.5M16.5 12L12 16.5M12 16.5L7.5 12M12 16.5V3" stroke="#667781" strokeWidth="2"/>
              </svg>
            </button>
            <button className="p-2 rounded-full hover:bg-gray-100 transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M4 12V12.01M12 12V12.01M20 12V12.01M4 6V6.01M12 6V6.01M20 6V6.01M4 18V18.01M12 18V18.01M20 18V18.01" stroke="#667781" strokeWidth="2"/>
              </svg>
            </button>
            <button
              onClick={() => {
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M18 6L6 18M6 6L18 18" stroke="#667781" strokeWidth="2"/>
              </svg>
            </button>
          </div>
        ) : (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-8">
            <div className="w-24 h-24 bg-[#F0F2F5] rounded-full flex items-center justify-center mb-4">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
                <path d="M10 13C10.4295 13.5741 10.9774 14.0491 11.6066 14.3929C12.2357 14.7367 12.9315 14.9411 13.6467 14.9923C14.3618 15.0435 15.0796 14.9403 15.7513 14.6897C16.4231 14.4392 17.0331 14.047 17.54 13.54L20.54 10.54C21.4508 9.59695 21.9548 8.33394 21.9434 7.02296C21.932 5.71198 21.4061 4.45791 20.4791 3.53087C19.5521 2.60383 18.298 2.07799 16.987 2.0666C15.676 2.0552 14.413 2.55918 13.47 3.47L11.75 5.18" stroke="#667781" strokeWidth="2"/>
                <path d="M14 11C13.5705 10.4259 13.0226 9.95085 12.3934 9.60706C11.7643 9.26327 11.0685 9.05885 10.3533 9.00769C9.63819 8.95653 8.92037 9.05971 8.24860 9.31026C7.57682 9.56081 6.96687 9.95301 6.46 10.46L3.46 13.46C2.54918 14.403 2.04520 15.6661 2.05660 16.977C2.06799 18.288 2.59383 19.5421 3.52087 20.4691C4.44791 21.3962 5.70198 21.922 7.01296 21.9334C8.32394 21.9448 9.58695 21.4408 10.53 20.53L12.24 18.82" stroke="#667781" strokeWidth="2"/>
              </svg>
            </div>
            <h3 className="text-[20px] font-medium text-[#667781] mb-2">No links yet</h3>
