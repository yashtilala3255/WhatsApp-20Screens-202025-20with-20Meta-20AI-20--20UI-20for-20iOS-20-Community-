...
const mockStarredMessages: StarredMessage[] = [
  ...
  },
  {
    ...
    message:
      "Welcome to the class of 1985! Please review the upcoming events and remember to submit your assignments on time.",
    timestamp: "Monday",
    messageType: "text",
...
export default function StarredMessages() {
  ...
  const filteredMessages = mockStarredMessages.filter(
    (message) =>
    ...
    switch (type) {
      ...
      case "audio":
        return (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path
              d="M12 1C12 1 8 1 8 5V12C8 16 12 16 12 16C12 16 16 16 16 12V5C16 1 12 1 12 1Z"
              stroke="#667781"
              strokeWidth="2"
            />
            <path
  ...
  const StarredMessageItem: React.FC<{ message: StarredMessage }> = ({
    message,
  }) => (
    <Link
              ...
              <div className="px-4 py-3 bg-[#FFFDE7] border-b border-[#FFF9C4]">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[14px] text-[#F57F17] leading-relaxed">
                    Tap and hold any message in a chat to star it for easy
                    access later.
                  </p>
                </div>
              </div>
