  ...
  return (
    <div className="w-full max-w-[393px] h-screen flex flex-col bg-white relative overflow-hidden text-rendering-optimized">
      ...
      <div className="px-4 pb-2">
        <h1 className="text-[33px] font-bold text-black tracking-[-1.33px] leading-none">Communities</h1>
      </div>
        ...
        <div className="flex flex-col justify-center items-start gap-[10px] w-full">
          ...
          <button className="flex justify-center items-center gap-[2px] w-full hover:bg-gray-50 active:bg-gray-100 transition-colors touch-target py-2">
            ...
            <div className="w-3 h-3 flex items-center justify-center">
              <svg width="5" height="9" viewBox="0 0 5 9" fill="none" className="fill-[#1DAB61]">
                <path fillRule="evenodd" clipRule="evenodd" d="M0.57573 1.07564C0.810044 0.841324 1.18994 0.841324 1.42426 1.07564L5.42426 5.07564C5.65857 5.30995 5.65857 5.68985 5.42426 5.92417L1.42426 9.92417C1.18994 10.1585 0.810044 10.1585 0.57573 9.92417C0.341415 9.68985 0.341415 9.30995 0.57573 9.07564L4.15147 5.4999L0.57573 1.92417C0.341415 1.68985 0.341415 1.30995 0.57573 1.07564Z" fill="#1DAB61"/>
              </svg>
            </div>
          </button>
