  ...
  return (
    <div className="w-[393px] mx-auto h-screen flex flex-col bg-white relative overflow-hidden">
      ...
      <div className="px-4 pb-2">
        <h1 className="text-[33px] font-bold text-black tracking-[-1.33px] leading-none">Updates</h1>
      </div>
      ...
      <div className="flex-1 pt-[18px] pb-[83px] flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-[13px]">
          <div className="px-4 h-[25px] flex items-center">
            <h2 className="text-[18px] font-semibold text-black tracking-[-0.18px]">Status</h2>
          </div>
        ...
        <div className="flex flex-col gap-2 pb-4">
          <div className="px-4">
            <h3 className="text-[#767779] text-[16px] font-semibold tracking-[-0.87px] leading-[19px]">Recent updates</h3>
          </div>
          ...
          <div className="flex flex-col">
            <Link to="/status/1" className="flex items-center gap-[9px] pl-[15px] hover:bg-gray-50">
              ...
              <div className="flex-1 py-[18px] pr-4 relative">
                <div className="flex flex-col gap-[1px]">
                  <div className="text-base font-semibold text-black tracking-[-0.32px]">Mr. Strickland</div>
                  <div className="text-sm text-[#767779] tracking-[-0.14px] leading-[19px]">4h ago</div>
                </div>
            ...
            <Link to="/status/2" className="flex items-center gap-[9px] pl-[15px] hover:bg-gray-50">
              ...
              <div className="flex-1 py-[18px] pr-4">
                <div className="flex flex-col gap-[1px]">
                  <div className="text-base font-semibold text-black tracking-[-0.32px]">Jenny ❤️</div>
                  <div className="text-sm text-[#767779] tracking-[-0.14px] leading-[19px]">9h ago</div>
                </div>
              </div>
            </Link>
          </div>
        ...
        <div className="flex flex-col gap-[13px] h-[191px]">
          <div className="px-4 h-[25px] flex items-center">
            <h2 className="text-[18px] font-semibold text-black tracking-[-0.18px]">Channels</h2>
          </div>
