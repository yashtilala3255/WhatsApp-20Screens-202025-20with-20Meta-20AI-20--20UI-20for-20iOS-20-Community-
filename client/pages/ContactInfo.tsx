  ...
  <div className="flex pl-[18px] items-center gap-[18.66px] self-stretch relative">
    ...
    <div className="flex min-h-[40px] py-[11px] pr-[9px] justify-between items-center flex-1 relative">
      ...
      <div className="flex flex-col items-start flex-1">
        ...
        {info && (
          <div className="text-[#767779] text-[11px] self-stretch">
            {info}
          </div>
        )}
      </div>
      <div className="flex justify-end items-center gap-2">
        ...
        {chevron && !toggle && (
          <svg className="w-6 h-6" viewBox="0 0 24 25">
            <path d="M10.5 7.66016L15 12.1602L10.5 16.6602" stroke="#CCCCCC" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        )}
      </div>
    </div>
    ...
    <div className="flex flex-col w-full max-w-[393px] min-h-screen bg-[#F4F4F4] mx-auto relative">
      ...
      <div className="flex w-full h-[98px] px-4 pr-0 justify-between items-end pb-[6px] pt-1">
        ...
        <div className="flex py-[6px] justify-end items-center">
          <span className="text-[#0A0A0A] text-[17px] tracking-[-0.336px]">Edit</span>
        </div>
      </div>
      ...
      <div className="flex px-4 pb-[38px] pt-[18px] flex-col items-center gap-4 self-stretch">
          ...
          <div className="flex items-start gap-2 self-stretch">
            <div className="flex h-[73px] px-2 py-[14.5px] flex-col items-center gap-[5px] flex-1 bg-white rounded-[10px]">
              <div className="w-6 h-6 fill-[#1DAB61]">
                <svg className="w-[18px] h-[18px] absolute ml-[3px] mt-[3px]" viewBox="0 0 18 18">
                  <circle cx="9" cy="9" r="8" stroke="#1DAB61" strokeWidth="1.5" fill="none"/>
                </svg>
              </div>
              <span className="text-[#0A0A0A] text-[14px] leading-[19px] tracking-[-0.14px]">Audio</span>
            </div>
            
            <div className="flex h-[73px] px-2 py-[14.5px] flex-col items-center gap-[5px] flex-1 bg-white rounded-[10px]">
              <svg className="w-6 h-6" viewBox="0 0 24 16">
                <path fillRule="evenodd" clipRule="evenodd" d="M3.50103 0.255859C1.84361 0.255859 0.5 1.59947 0.5 3.25689V12.3509C0.5 14.0083 1.84361 15.352 3.50103 15.352H14.8686C16.5261 15.352 17.8697 14.0083 17.8697 12.3509V10.5485L20.7882 13.0894C21.8475 14.0116 23.5 13.2593 23.5 11.8548V3.24878C23.5 1.84432 21.8475 1.09198 20.7882 2.01418L17.8697 4.55511V3.25689C17.8697 1.59947 16.5261 0.255859 14.8686 0.255859H3.50103Z" fill="#1DAB61"/>
              </svg>
              <span className="text-[#0A0A0A] text-[14px] leading-[19px] tracking-[-0.14px]">Video</span>
            </div>
            
            <div className="flex h-[73px] px-2 py-[14.5px] flex-col items-center gap-[5px] flex-1 bg-white rounded-[10px]">
              <svg className="w-6 h-6" viewBox="0 0 25 25">
                <path d="M3.5 10.1714C3.5 14.2246 6.79785 17.5225 10.8511 17.5225C12.4539 17.5225 13.9186 17.0066 15.1254 16.1407L19.6576 20.6821C19.8695 20.894 20.1459 20.9953 20.4406 20.9953C21.067 20.9953 21.5 20.5255 21.5 19.9083C21.5 19.6136 21.3895 19.3464 21.196 19.153L16.6914 14.6207C17.6402 13.3863 18.2021 11.8479 18.2021 10.1714C18.2021 6.11816 14.9043 2.82031 10.8511 2.82031C6.79785 2.82031 3.5 6.11816 3.5 10.1714Z" fill="#1DAB61"/>
              </svg>
              <span className="text-[#0A0A0A] text-[14px] leading-[19px] tracking-[-0.14px]">Search</span>
            </div>
          </div>
        </div>
          ...
          <SettingsRow
            icon={
              <svg className="w-5 h-[19px] fill-[#0A0A0A]" viewBox="0 0 22 20">
                <path fillRule="evenodd" clipRule="evenodd" d="M10.1361 1.18329C10.3721 0.29828 11.628 0.29828 11.864 1.18329L13.4792 7.24052H20.1247C20.9839 7.24052 21.3486 8.3344 20.6612 8.84997L15.681 12.5851L17.3562 18.8669C17.5749 19.6871 16.6348 20.3219 15.9557 19.8126L11 16.0958L6.04428 19.8126C5.36523 20.3219 4.42514 19.6871 4.64385 18.8669L6.31901 12.5851L1.33885 8.84997C0.651425 8.3344 1.01606 7.24052 1.87534 7.24052H8.52079L10.1361 1.18329Z"/>
              </svg>
            }
        ...
        <div className="flex flex-col items-start self-stretch bg-white rounded-[10px]">
          ...
          <SettingsRow
            icon={
              <svg className="w-[22px] h-[18px] fill-[#0A0A0A]" viewBox="0 0 22 19">
                <path fillRule="evenodd" clipRule="evenodd" d="M1.45005 9.90985C1.45005 5.73296 5.69222 2.10996 11.25 2.10996C14.0811 2.10996 16.466 2.59991 18.1152 3.41283C19.7751 4.23105 20.55 5.29122 20.55 6.40996C20.55 6.91575 20.3282 7.33923 19.9034 7.75118C19.4629 8.17834 18.8516 8.54584 18.1649 8.92043C18.0387 8.98927 17.9085 9.05901 17.7765 9.12971C17.2297 9.42265 16.6521 9.73214 16.1977 10.0626C15.6445 10.465 15.05 11.0538 15.05 11.91C15.05 12.9542 15.7399 13.6416 16.2017 14.1017L16.2551 14.1549C16.7952 14.6951 17.05 14.9953 17.05 15.41C17.05 15.6327 16.9343 15.8716 16.5455 16.1347C16.1493 16.4028 15.5651 16.6233 14.8756 16.7924C13.506 17.1284 11.9421 17.21 11.25 17.21C8.477 17.21 6.00458 16.4187 4.24318 15.1086C2.48989 13.8046 1.45005 12 1.45005 9.90985Z"/>
              </svg>
            }
            label="Chat theme"
          />
          <SettingsRow
            icon={
              <svg className="w-4 h-5 fill-[#0A0A0A]" viewBox="0 0 18 22">
                <path fillRule="evenodd" clipRule="evenodd" d="M9.7 1.65996C9.7 1.27336 9.3866 0.959961 9 0.959961C8.6134 0.959961 8.3 1.27336 8.3 1.65996V12.97L5.99497 10.665C5.72161 10.3916 5.27839 10.3916 5.00502 10.665C4.73166 10.9384 4.73166 11.3816 5.00502 11.6549L8.50502 15.1549C8.77839 15.4283 9.22161 15.4283 9.49497 15.1549L12.995 11.6549C13.2683 11.3816 13.2683 10.9384 12.995 10.665C12.7216 10.3916 12.2784 10.3916 12.005 10.665L9.7 12.97V1.65996Z"/>
              </svg>
            }
          ...
          <SettingsRow
            icon={
              <svg className="w-[11px] h-4 fill-[#0A0A0A]" viewBox="0 0 12 17">
                <path fillRule="evenodd" clipRule="evenodd" d="M6 0.459961C3.6804 0.459961 1.8 2.34037 1.8 4.65996V6.9716C0.955365 7.07059 0.299999 7.78874 0.299999 8.65996V15.16C0.299999 16.0988 1.06112 16.86 2 16.86H10C10.9389 16.86 11.7 16.0988 11.7 15.16V8.65996C11.7 7.78874 11.0446 7.07059 10.2 6.9716V4.65996C10.2 2.34037 8.3196 0.459961 6 0.459961Z"/>
              </svg>
            }
            label="Encryption"
