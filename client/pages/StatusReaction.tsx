          ...
          <div className="absolute inset-0 flex items-center gap-2 px-2 py-[5.5px]">
            ...
            <div className="flex items-end gap-4 flex-1 px-[9px] py-[3px] border-[0.33px] border-[#B2B2B2] bg-white rounded-[15px]">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M11.6155 2.90003L13.9359 2.90003C14.4593 2.90003 14.7592 2.90002 15.0179 2.92038C18.2543 3.1751 20.825 5.74572 21.0797 8.9822C21.1 9.24087 21.1 9.54075 21.1 10.0642V10.1376C21.1 10.938 21.1 11.3771 21.0704 11.7532C20.6999 16.4609 16.9609 20.1999 12.2532 20.5704C11.8771 20.6 11.438 20.6 10.6376 20.6H10.2524C9.5543 20.6 9.15436 20.6001 8.81015 20.5639C5.71097 20.2381 3.26192 17.7891 2.93619 14.6899C2.90001 14.3457 2.90002 13.9458 2.90003 13.2478L2.90003 11.6155C2.89993 9.6494 2.89987 8.52155 3.18423 7.58415C3.8241 5.47478 5.47478 3.8241 7.58415 3.18423C8.52155 2.89987 9.6494 2.89993 11.6155 2.90003Z" fill="#0A0A0A"/>
              </svg>
            </div>
            ...
            <div className="flex items-start gap-[7px] pl-[6px]">
              <div className="w-8 h-8 flex items-center justify-center">
                <svg width="24" height="18" viewBox="0 0 24 18" fill="none">
                  <path fillRule="evenodd" clipRule="evenodd" d="M8.3302 1.58094C8.80515 1.02209 9.50156 0.700012 10.235 0.700012H13.762C14.4954 0.700012 15.1918 1.02209 15.6668 1.58094L16.3484 2.38293C16.5193 2.58408 16.77 2.70001 17.034 2.70001H20.7499C22.4344 2.70001 23.7999 4.06554 23.7999 5.75001V15.75C23.7999 17.4345 22.4344 18.8 20.75 18.8H3.24995C1.56548 18.8 0.199951 17.4345 0.199951 15.75V5.75001C0.199951 4.06554 1.56548 2.70001 3.24995 2.70001H6.96302C7.227 2.70001 7.47766 2.58408 7.64861 2.38293L8.3302 1.58094Z" fill="#0A0A0A"/>
                </svg>
              </div>
              <div className="w-8 h-8 flex items-center justify-center">
                <svg width="16" height="23" viewBox="0 0 16 23" fill="none">
                  <path d="M8 15C10.2091 15 12 13.2091 12 11V4C12 1.79086 10.2091 0 8 0C5.79086 0 4 1.79086 4 4V11C4 13.2091 5.79086 15 8 15Z" fill="#0A0A0A"/>
          ...
          <div className="px-[1px] py-[3px] h-[39px]">
            <div className="flex items-center gap-[2px] h-[39px]">
              <div className="flex-1 bg-[#EBEDF0] rounded-[4.6px] h-[39px] flex items-center justify-center">
                <span className="text-black text-[17px] font-normal tracking-[-0.43px] leading-[22px]">"The"</span>
              </div>
              ...
              <div className="flex-1 h-[39px] flex items-center justify-center">
                <span className="text-black text-[17px] font-normal tracking-[-0.43px] leading-[22px]">to</span>
              </div>
            </div>
          </div>
          ...
          <div className="h-[204px] relative">
            ...
            <div className="absolute top-0 left-[3px] flex items-start gap-[6px] w-[387px] h-[42px]">
              {['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p'].map((letter) => (
                <div key={letter} className="flex-1 h-[42px] bg-[#FCFCFE] rounded-[4.6px] shadow-[0_1px_0_0_#898A8D] flex items-center justify-center relative">
                  <span className="text-black text-[25px] font-normal leading-[28px] absolute -top-[6px]">{letter}</span>
                </div>
              ))}
            </div>
            ...
            <div className="absolute top-[108px] left-[3px] w-[44px] h-[42px] bg-[#ABB0BA] rounded-[4.6px] shadow-[0_1px_0_0_#898A8D] flex items-center justify-center">
              <span className="text-black text-[20px] font-normal leading-[28px]">⇧</span>
            </div>
            ...
            <div className="absolute top-[162px] left-[3px] w-[92px] h-[42px] bg-[#ABB0BA] rounded-[4.6px] shadow-[0_1px_0_0_#898A8D] flex items-center justify-center">
              <span className="text-black text-[16px] font-normal tracking-[-0.31px] leading-[21px]">ABC</span>
            </div>
            ...
            <div className="absolute top-[162px] left-[101px] w-[191px] h-[42px] bg-[#FCFCFE] rounded-[4.6px] shadow-[0_1px_0_0_#898A8D] flex items-center justify-center">
              <span className="text-black text-[16px] font-normal tracking-[-0.31px] leading-[21px]">space</span>
            </div>
            ...
            <div className="absolute top-[162px] right-[3px] w-[92px] h-[42px] bg-[#ABB0BA] rounded-[4.6px] shadow-[0_1px_0_0_#898A8D] flex items-center justify-center">
              <span className="text-black text-[16px] font-normal tracking-[-0.31px] leading-[21px]">return</span>
            </div>
          </div>

          {/* Emoji and Mic */}
          <div className="flex justify-between items-start px-5 pt-[25px] h-[58px]">
            <svg width="27" height="27" viewBox="0 0 27 27" fill="none" className="fill-[#3C3C43]/80">
              <path d="M13.45 18.39C11.34 18.39 9.1 18.09 7.06 17.57C6.68 16.99 6.4 16.37 6.27 15.74C8.42 16.35 10.92 16.77 13.46 16.77C16 16.77 18.5 16.35 20.66 15.74C20.51 16.37 20.24 16.99 19.87 17.57C17.83 18.08 15.59 18.39 13.46 18.39H13.45Z" fill="#3C3C43" fillOpacity="0.8"/>
            </svg>
