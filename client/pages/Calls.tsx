  ...
  const callsData = [
    {
      ...
      type: "outgoing",
      time: "14:01",
      profileImage: "https://api.builder.io/api/v1/image/assets/TEMP/4c4a5af127d840b7402719dbbfdd77f20d2b99a7?width=80"
    },
    {
      id: 2,
      name: "Daddy",
    ...
    },
    {
      ...
      type: "outgoing",
      time: "15/10/85",
      profileImage: "https://api.builder.io/api/v1/image/assets/TEMP/2f74a7b374d94e89d563d84ba3c9febd0fc2b66c?width=80"
    },
    {
      id: 5,
      name: "Jenny ❤️",
    ...
    },
    {
      ...
      type: "outgoing",
      time: "02/09/85",
      profileImage: "https://cdn.builder.io/api/v1/image/assets%2F58a45ac74f684c229db5d48c4fd195ba%2Fe7a05b7034734d20a462b690bddc15f7?format=webp&width=80"
    }
  ];
  ...
  return (
    <div className="w-full max-w-[393px] h-screen flex flex-col bg-white relative overflow-hidden text-rendering-optimized">
      ...
      <div className="flex justify-between items-end px-4 py-2 h-[98px] gap-4">
        ...
        <button className="w-7 h-7 rounded-full bg-[#1DAB61] flex items-center justify-center touch-target hover:bg-[#169954] transition-colors">
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            <path fillRule="evenodd" clipRule="evenodd" d="M7 1C7 0.447715 6.55228 0 6 0C5.44772 0 5 0.447715 5 1V5H1C0.447715 5 0 5.44772 0 6C0 6.55228 0.447715 7 1 7H5V11C5 11.5523 5.44772 12 6 12C6.55228 12 7 11.5523 7 11V7H11C11.5523 7 12 6.55228 12 6C12 5.44772 11.5523 5 11 5H7V1Z" fill="white"/>
          </svg>
        </button>
      </div>
      ...
      <div className="px-4 pb-2">
        <h1 className="text-[33px] font-bold text-black tracking-[-1.33px] leading-none">Calls</h1>
      </div>
      ...
      <div className="flex-1 pt-[22px] pb-[83px] flex flex-col gap-8 custom-scrollbar overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          <div className="px-4 h-[25px] flex items-center">
            <h2 className="text-[18px] font-semibold text-black tracking-[-0.18px]">Favourites</h2>
          </div>
          ...
          <button className="flex items-center gap-4 px-4 hover:bg-gray-50 active:bg-gray-100 transition-colors touch-target">
            <div className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center">
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M7 1C7 0.447715 6.55228 0 6 0C5.44772 0 5 0.447715 5 1V5H1C0.447715 5 0 5.44772 0 6C0 6.55228 0.447715 7 1 7H5V11C5 11.5523 5.44772 12 6 12C6.55228 12 7 11.5523 7 11V7H11C11.5523 7 12 6.55228 12 6C12 5.44772 11.5523 5 11 5H7V1Z" fill="#0A0A0A"/>
              </svg>
            </div>
            <span className="text-[16px] text-black tracking-[-0.205px] leading-[21px]">Add favourite</span>
          </button>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <div className="px-4 h-[25px] flex items-center">
            <h2 className="text-[18px] font-semibold text-black tracking-[-0.18px]">Recent</h2>
          </div>
              ...
              >
                ...
                <div className="flex-1 pt-[10px] pr-4 pb-0 flex items-start gap-2">
                  <div className="flex-1 flex flex-col gap-[1.5px]">
                    <div className={`text-base font-normal tracking-[-0.32px] leading-none truncate text-left ${
                  ...
                  <div className="flex items-center gap-[14px] py-[6.33px]">
                    ...
                    <div className="w-[26px] h-[26px] flex items-center justify-center">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="fill-black">
                        <path fillRule="evenodd" clipRule="evenodd" d="M10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2ZM0 10C0 4.47715 4.47715 0 10 0C15.5228 0 20 4.47715 20 10C20 15.5228 15.5228 20 10 20C4.47715 20 0 15.5228 0 10ZM9 9L10 9V13H8.5C8.22386 13 8 13.2239 8 13.5C8 13.7761 8.22386 14 8.5 14H11.5C11.7761 14 12 13.7761 12 13.5C12 13.2239 11.7761 13 11.5 13H11V8.5C11 8.36739 10.9473 8.24021 10.8536 8.14645C10.7598 8.05268 10.6326 8 10.5 8H10H9C8.72386 8 8.5 8.22386 8.5 8.5C8.5 8.77614 8.72386 9 9 9ZM10 6.5C10.5523 6.5 11 6.05228 11 5.5C11 4.94772 10.5523 4.5 10 4.5C9.44772 4.5 9 4.94772 9 5.5C9 6.05228 9.44772 6.5 10 6.5Z" fill="#0A0A0A"/>
                      </svg>
                    </div>
                  </div>
                </div>
