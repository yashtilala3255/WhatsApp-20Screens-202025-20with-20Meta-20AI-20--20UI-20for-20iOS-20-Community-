    ...
    <div className="flex min-h-[40px] py-[11px] pr-[9px] justify-between items-center flex-1 relative">
      ...
      <div className="flex justify-end items-center">
        ...
        <svg className="w-6 h-6" viewBox="0 0 24 25">
          <path d="M10.5 8L15 12.5L10.5 17" stroke="#CCCCCC" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
    </div>
  </div>
    ...
    <div className="flex flex-col w-full max-w-[393px] min-h-screen bg-[#F4F4F4] mx-auto relative">
      ...
      <div className="flex px-4 pb-[38px] flex-col items-start gap-[35px] self-stretch">
        ...
        <div className="flex flex-col items-start self-stretch bg-white rounded-[10px]">
          ...
          <SettingsRow
            icon={
              <svg className="w-[19px] h-[18px] fill-[#0A0A0A]" viewBox="0 0 20 19">
                <path fillRule="evenodd" clipRule="evenodd" d="M14.8 3.66039C13.0878 4.59477 11.1261 5.0937 9.52303 5.36463C8.61926 5.51738 7.81187 5.60045 7.2 5.6457V11.8544C7.81187 11.8997 8.61926 11.9828 9.52303 12.1355C11.1261 12.4065 13.0878 12.9054 14.8 13.8398V3.66039Z"/>
              </svg>
            }
        ...
        <div className="flex flex-col items-start self-stretch bg-white rounded-[10px]">
          ...
          <SettingsRow
            icon={
              <div className="w-[17px] h-[17px] fill-[#0A0A0A]" />
            }
            label="Notifications"
          />
          <SettingsRow
        ...
        <div className="flex flex-col items-start self-stretch bg-white rounded-[10px]">
          <SettingsRow
            icon={
              <svg className="w-[17px] h-[17px] fill-[#0A0A0A]" viewBox="0 0 18 19">
                <path fillRule="evenodd" clipRule="evenodd" d="M9.00005 2.1998C4.96837 2.1998 1.70005 5.46813 1.70005 9.4998C1.70005 13.5315 4.96837 16.7998 9.00005 16.7998C13.0317 16.7998 16.3 13.5315 16.3 9.4998C16.3 5.46813 13.0317 2.1998 9.00005 2.1998ZM0.300049 9.4998C0.300049 4.69493 4.19517 0.799805 9.00005 0.799805C13.8049 0.799805 17.7001 4.69493 17.7001 9.4998C17.7001 14.3047 13.8049 18.1998 9.00005 18.1998C4.19517 18.1998 0.300049 14.3047 0.300049 9.4998Z"/>
              </svg>
            }
            label="Help"
          />
        ...
        <div className="flex flex-col items-start gap-2 self-stretch">
          ...
          <div className="flex flex-col items-start self-stretch bg-white rounded-[10px]">
            <SettingsRow
              icon={
                <svg className="w-[21px] h-[21px] fill-[#0A0A0A]" viewBox="0 0 22 22">
                  <path fillRule="evenodd" clipRule="evenodd" d="M0.450001 6.2502C0.450001 3.04694 3.04675 0.450195 6.25 0.450195H15.75C18.9533 0.450195 21.55 3.04694 21.55 6.2502V15.7502C21.55 18.9534 18.9533 21.5502 15.75 21.5502H6.25C3.04675 21.5502 0.450001 18.9534 0.450001 15.7502V6.2502ZM6.25 2.0502C3.9304 2.0502 2.05 3.9306 2.05 6.2502V15.7502C2.05 18.0698 3.9304 19.9502 6.25 19.9502H15.75C18.0696 19.9502 19.95 18.0698 19.95 15.7502V6.2502C19.95 3.9306 18.0696 2.0502 15.75 2.0502H6.25ZM11 7.0502C8.81848 7.0502 7.05 8.81867 7.05 11.0002C7.05 13.1817 8.81848 14.9502 11 14.9502C13.1815 14.9502 14.95 13.1817 14.95 11.0002C14.95 8.81867 13.1815 7.0502 11 7.0502Z"/>
                </svg>
              }
            ...
            <SettingsRow
              icon={
                <svg className="w-[23px] h-[23px] fill-[#0A0A0A]" viewBox="0 0 24 23">
                  <path fillRule="evenodd" clipRule="evenodd" d="M2.3 11.5002C2.3 6.14303 6.64284 1.8002 12 1.8002C17.3572 1.8002 21.7 6.14303 21.7 11.5002C21.7 16.4996 17.9179 20.6156 13.0588 21.1431V14.5757H16.3235L16.4118 11.4978H13.0588V9.27496C13.0588 8.42001 13.2353 7.90704 14.3824 7.90704H16.4118L16.5 5.08569C16.5 5.08569 15.5294 5.0002 14.2941 5.0002C11.1176 5.0002 9.79412 6.88109 9.79412 8.93298V11.4978H7.5V14.5757H9.79412L9.79396 20.9482C5.49963 19.9495 2.3 16.0985 2.3 11.5002Z"/>
                </svg>
              }
              label="Open Facebook"
            />
