  ...
  const getFlashIcon = () => {
    switch (flashMode) {
      case 'off':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M17 10H20L11 21V14H8L17 3V10Z" stroke="white" strokeWidth="2"/>
      ...
      case 'on':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M17 10H20L11 21V14H8L17 3V10Z" stroke="white" strokeWidth="2" fill="white"/>
          </svg>
        );
      case 'auto':
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M17 10H20L11 21V14H8L17 3V10Z" stroke="white" strokeWidth="2"/>
            <text x="12" y="6" textAnchor="middle" fill="white" fontSize="8">A</text>
          </svg>
        );
    }
  };
    ...
    <div className="w-full max-w-[393px] h-screen flex flex-col bg-black relative overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-4 absolute top-12 left-0 right-0 z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M17 14V12C17 9.23858 14.7614 7 12 7C9.23858 7 7 9.23858 7 12V14" stroke="white" strokeWidth="2"/>
              <path d="M17 14H19C20.1046 14 21 14.8954 21 16V18C21 19.1046 20.1046 20 19 20H17V14Z" stroke="white" strokeWidth="2"/>
              <path d="M7 14H5C3.89543 14 3 14.8954 3 16V18C3 19.1046 3.89543 20 5 20H7V14Z" stroke="white" strokeWidth="2"/>
      ...
      <div className="flex-1 relative bg-gray-900">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-800">
          <div className="text-center">
            ...
            <p className="text-white/60 text-[14px]">Enable camera access to see live preview</p>
          </div>
        </div>
      ...
      <div className="px-4 py-6 bg-black">
        ...
        <div className="text-center mt-4">
          <p className="text-white/60 text-[14px]">
            {cameraMode === 'photo' ? 'Tap to capture' : isRecording ? 'Recording...' : 'Hold to record'}
          </p>
        </div>
      </div>
    </div>
